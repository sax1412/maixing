...
//checkbox全选
    ...
    $("input[id=lefile2]").wrap("<form id='myupload2' action='/admin/contact/upload' method='post' enctype='multipart/form-data'></form>");
    ...
    $("input[id=lefile3]").wrap("<form id='myupload3' action='/admin/contact/upload' method='post' enctype='multipart/form-data'></form>");
