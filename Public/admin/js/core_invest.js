...
//checkbox全选
    ...
    $("input[id=lefile]").wrap("<form id='myupload' action='/admin/invest/upload' method='post' enctype='multipart/form-data'></form>");
...
function initTable() {
    var table = $("#example").dataTable({
        ...
        "searching": true,
        "sAjaxSource": "/admin/invest/invest_list",
        'bPaginate': true,
        "bDestory": true,
        "bRetrieve": true,
        "bFilter": false,
